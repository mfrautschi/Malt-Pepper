 ...
 <head>
  ...
  <body id="body-contactus">
    ...
    <header>
      <nav id="nav-website">
        ...
        <div id="nav-description-website">
          ...
          <li><a style="color: #C48C2B" href="gallery_logout.php">Gallery</a></li>
    ...
    <div id="contentgallery">
      ...
      ?>
        ...
        <div id="div-member">
          ...
          <form style="font-size: 17px; color: #3D3D3D;" action="gallery_logout.php" method="post" enctype="multipart/form-data">
    ...
    <footer>
      ...
      <div id="footer-gallery-logout">


        <div id="footer-description-gallery-logout">
        ...
        <div id="footer-icon-gallery-logout">
